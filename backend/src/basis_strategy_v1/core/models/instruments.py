...
INSTRUMENTS: Dict[str, InstrumentDefinition] = {
    ...
    "wallet:BaseToken:USDT": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="USDT",
    ...
    "wallet:BaseToken:ETH": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="ETH",
    ...
    "wallet:BaseToken:BTC": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="BTC",
    ...
    "wallet:BaseToken:WETH": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="WETH",
    ...
    "wallet:BaseToken:EIGEN": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="EIGEN",
    ...
    "wallet:BaseToken:ETHFI": InstrumentDefinition(
        ...
        venue="wallet", position_type="BaseToken", symbol="ETHFI",
    ...
    "binance:BaseToken:USDT": InstrumentDefinition(
        ...
        venue="binance", position_type="BaseToken", symbol="USDT",
    ...
    "binance:BaseToken:BTC": InstrumentDefinition(
        ...
        venue="binance", position_type="BaseToken", symbol="BTC",
    ...
    "binance:BaseToken:ETH": InstrumentDefinition(
        ...
        venue="binance", position_type="BaseToken", symbol="ETH",
    ...
    "binance:Perp:BTCUSDT": InstrumentDefinition(
        ...
        venue="binance", position_type="Perp", symbol="BTCUSDT",
    ...
    "binance:Perp:ETHUSDT": InstrumentDefinition(
        ...
        venue="binance", position_type="Perp", symbol="ETHUSDT",
    ...
    "bybit:BaseToken:USDT": InstrumentDefinition(
        ...
        venue="bybit", position_type="BaseToken", symbol="USDT",
    ...
    "bybit:Perp:BTCUSDT": InstrumentDefinition(
        ...
        venue="bybit", position_type="Perp", symbol="BTCUSDT",
    ...
    "bybit:Perp:ETHUSDT": InstrumentDefinition(
        ...
        venue="bybit", position_type="Perp", symbol="ETHUSDT",
    ...
    "okx:BaseToken:USDT": InstrumentDefinition(
        ...
        venue="okx", position_type="BaseToken", symbol="USDT",
    ...
    "okx:Perp:BTCUSDT": InstrumentDefinition(
        ...
        venue="okx", position_type="Perp", symbol="BTCUSDT",
    ...
    "okx:Perp:ETHUSDT": InstrumentDefinition(
        ...
        venue="okx", position_type="Perp", symbol="ETHUSDT",
    ...
    "aave_v3:aToken:aUSDT": InstrumentDefinition(
        ...
        venue="aave_v3", position_type="aToken", symbol="aUSDT",
    ...
    "aave_v3:debtToken:debtUSDT": InstrumentDefinition(
        ...
        venue="aave_v3", position_type="debtToken", symbol="debtUSDT",
    ...
    "aave_v3:aToken:aWETH": InstrumentDefinition(
        ...
        venue="aave_v3", position_type="aToken", symbol="aWETH",
    ...
    "aave_v3:debtToken:debtWETH": InstrumentDefinition(
        ...
        venue="aave_v3", position_type="debtToken", symbol="debtWETH",
    ...
    "aave_v3:aToken:aweETH": InstrumentDefinition(
        ...
        venue="aave_v3", position_type="aToken", symbol="aweETH",
    ...
    "etherfi:LST:weETH": InstrumentDefinition(
        ...
        venue="etherfi", position_type="LST", symbol="weETH",
    ...
    "lido:LST:stETH": InstrumentDefinition(
        key="lido:LST:stETH",
        venue="lido", position_type="LST", symbol="stETH",
    ...
    "lido:LST:wstETH": InstrumentDefinition(
        key="lido:LST:wstETH",
        venue="lido", position_type="LST", symbol="wstETH",
...
def get_instrument(key: str) -> InstrumentDefinition:
    ...
    if key not in INSTRUMENTS:
        raise ValueError(f"Unknown instrument key: {key}. Must use canonical keys from INSTRUMENTS registry.")
...
def get_instruments_by_position_type(position_type: str) -> List[str]:
    ...
    return [key for key, instrument in INSTRUMENTS.items() if instrument.position_type == position_type]
...
def validate_instrument_keys(keys: List[str]) -> None:
    ...
    if invalid_keys:
        raise ValueError(f"Invalid instrument keys: {invalid_keys}. Must use canonical keys from INSTRUMENTS registry.")
...
def position_key_to_price_key(position_key: str) -> str:
    """
...
def position_key_to_oracle_pair(position_key: str, quote_currency: str = 'USD') -> str:
    """
...
def validate_instrument_in_registry(position_key: str) -> bool:
    """Validate position key exists in INSTRUMENTS registry."""
    return validate_instrument_key(position_key)
