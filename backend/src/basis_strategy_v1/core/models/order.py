...
class Order(BaseModel):
    ...
    # Core identification
    operation_id: str = Field(..., description="Unique operation identifier (generated by strategy)")
    ...
    token: Optional[str] = Field(None, description="Token symbol (legacy, use source_token/target_token)")
    
    # Expected position deltas (calculated by strategy BEFORE creating order)
    expected_deltas: Dict[str, float] = Field(..., description="Expected position changes: position_key -> delta_amount")
    
    # Operation-specific details
    operation_details: Dict[str, Any] = Field(default_factory=dict, description="Operation-specific parameters and context")
