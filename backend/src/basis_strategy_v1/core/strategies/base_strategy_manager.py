...
class BaseStrategyManager(ABC):
    ...
    @abstractmethod
    def generate_orders(self, timestamp: pd.Timestamp, exposure: Dict, 
                       risk_assessment: Dict, market_data: Dict) -> List[Order]:
        """
    ...
    @abstractmethod
    def should_enter_position(self, current_equity: float, exposure_data: Dict, 
