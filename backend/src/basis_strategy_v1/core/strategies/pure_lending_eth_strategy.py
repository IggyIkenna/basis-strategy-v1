...
class PureLendingETHStrategy(BaseStrategyManager):
    ...
    def __init__(self, config: Dict[str, Any], data_provider, exposure_monitor, 
        ...
        self.logger.info(f"PureLendingETHStrategy initialized for {self.asset}")
    ...
    def generate_orders(
        ...
        try:
            ...
            deviation_threshold = self.strategy_config.get('position_deviation_threshold', 0.02)  # 2% default
        ...
        try:
            ...
            for venue in self.lending_venues:
                ...
                if supply_amount > 0:
                    ...
                    operation_details = {}
                    if self.utility_manager and hasattr(self.utility_manager, '_get_aave_supply_index'):
                        try:
                            supply_index = self.utility_manager._get_aave_supply_index(self.asset, pd.Timestamp.now())
                    ...
                    orders.append(Order(
                        ...
                        source_venue='wallet',
                        target_venue=venue,
                        source_token=self.asset,
                        target_token=f'a{self.asset}',
                        token_in=self.asset,
        ...
        try:
            ...
            for venue in self.lending_venues:
                ...
                if supply_amount > 0:
                    ...
                    # Calculate expected deltas for supply operation
                    expected_deltas = {
                        f"{venue}:BaseToken:{self.asset}": -supply_amount,  # Lose ETH
                        f"{venue}:BaseToken:a{self.asset}": supply_amount   # Gain aETH
                    }
            ...
            for venue in self.lending_venues:
                ...
                if withdraw_amount > 0:
                    ...
                    orders.append(Order(
                        ...
                        source_venue=venue,
                        target_venue='wallet',
                        source_token=f'a{self.asset}',
                        target_token=self.asset,
