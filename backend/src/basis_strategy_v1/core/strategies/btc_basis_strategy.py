...
class BTCBasisStrategy(BaseStrategyManager):
    ...
    def __init__(self, config: Dict[str, Any], data_provider, exposure_monitor, 
        ...
        required_keys = ['btc_allocation', 'max_leverage']
        ...
        self.asset = 'BTC'  # BTC for this strategy
        ...
        self.logger.info(f"BTCBasisStrategy initialized with {self.btc_allocation*100}% BTC allocation")
    ...
    def _create_entry_full_orders(self, equity: float) -> List[Order]:
        ...
        try:
            ...
            orders.append(Order(
                ...
                target_token='BTC',
                expected_deltas={
                    self.perp_instrument: -btc_amount  # Short position
                },
                execution_mode='sequential',
                strategy_intent='entry_full',
                strategy_id='btc_basis'
