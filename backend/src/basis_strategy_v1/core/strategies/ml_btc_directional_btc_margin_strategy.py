...
class MLBTCDirectionalBTCMarginStrategy(BaseStrategyManager):
    ...
    def _get_ml_predictions(self, market_data: Dict) -> Dict:
        ...
        try:
            ...
            data = self.utility_manager.data_provider.get_data(market_data.get("timestamp"))
            ml_predictions = data["ml_data"]["predictions"]
    ...
    def _create_entry_full_orders(self, equity: float, signal: str) -> List[Order]:
        ...
        try:
            ...
            order = Order(
                ...
                target_token="BTC",
                expected_deltas={
                    self.perp_instrument: target_position["btc_perp_position"]
                    if signal == "long"
    ...
    def _create_entry_partial_orders(self, equity_delta: float, signal: str) -> List[Order]:
        ...
        try:
            ...
            order = Order(
                ...
                target_token="BTC",
                expected_deltas={
                    self.perp_instrument: partial_position
                    if signal == "long"
    ...
    def _create_exit_partial_orders(self, equity_delta: float) -> List[Order]:
        ...
        try:
            ...
            order = Order(
                ...
                target_token="BTC",
                expected_deltas={
                    self.perp_instrument: -partial_exit
                    if btc_position > 0
                    else partial_exit  # Close partial position
                },
                execution_mode="sequential",
