...
from ...core.models.instruments import position_key_to_price_key, position_key_to_oracle_pair
...
class LiveDeFiDataProvider:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(f"LiveDeFiDataProvider initialized for {len(self.position_subscriptions)} positions")
    ...
    def _init_aave(self) -> Optional[Dict]:
        ...
        api_key = os.getenv('AAVE_API_KEY')
