...
def create_data_provider(
    execution_mode: str, data_type: str, config: Dict[str, Any]
) -> Union[
    ...
    if execution_mode == "backtest" and data_type == "defi":
        ...
        raise ValueError(
            f"Unknown execution_mode: {execution_mode} or data_type: {data_type}. Must be 'backtest'/'live' and 'defi'/'cefi'"
        )


def get_data_provider_for_mode(
    mode: str, execution_mode: str = "backtest"
) -> Union[
    "HistoricalDeFiDataProvider",
    "HistoricalCeFiDataProvider",
    "LiveDeFiDataProvider",
