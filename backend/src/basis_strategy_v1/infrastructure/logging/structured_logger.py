...
class StructuredLogger:
    ...
    def __init__(
        self, component_name: str, correlation_id: str, pid: int, log_dir: Path, engine=None
    ):
        """
    ...
    def _setup_file_logger(self):
        ...
        self.file_logger = logging.getLogger(
            f"{self.component_name}_{self.correlation_id}_{self.pid}"
        )
    ...
    def error(
        ...
        **extra,
        ...
        log_dict = self._create_log_dict(
            "ERROR", message, error_code=error_code, exc_info=exc_info, **extra
        )
        self._write_log(log_dict)
    ...
    def critical(
        ...
        **extra,
        ...
        """
        log_dict = self._create_log_dict(
            "CRITICAL", message, error_code=error_code, exc_info=exc_info, **extra
        )
        self._write_log(log_dict)
    ...
    def log_business_event(
        self, event_type: str, message: str, metadata: Optional[Dict[str, Any]] = None, **extra
    ):
        """
