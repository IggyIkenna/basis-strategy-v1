import { ArrowLeft, ArrowRight, Check, Shield, Target, TrendingUp, Zap } from 'lucide-react';
...
interface InstitutionalModeSelectionStepProps {
    shareClass: string;
    selectedMode?: string;
...
export function InstitutionalModeSelectionStep({
    shareClass,
    selectedMode,
    onSelect,
    onNext,
    onBack
}: InstitutionalModeSelectionStepProps) {
...
export default InstitutionalModeSelectionStep;
