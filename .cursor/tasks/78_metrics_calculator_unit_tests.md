...
## Overview
Implement comprehensive unit tests for the Metrics calculator to ensure proper functionality with mocked dependencies.

## Reference
- **Component**: `backend/src/basis_strategy_v1/core/math/metrics_calculator.py`
...
### 1. Component Testing
- **File**: `tests/unit/test_metrics_calculator_unit.py`
...
## Quality Gate
**Quality Gate Script**: `tests/unit/test_metrics_calculator_unit.py`
