...
## Overview
Implement comprehensive unit tests for the Error code registry to ensure proper functionality with mocked dependencies.

## Reference
- **Component**: `backend/src/basis_strategy_v1/core/error_codes/error_code_registry.py`
...
### 1. Component Testing
- **File**: `tests/unit/test_error_code_registry_unit.py`
...
## Quality Gate
**Quality Gate Script**: `tests/unit/test_error_code_registry_unit.py`
