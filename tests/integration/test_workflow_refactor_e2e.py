...
class MockStrategy:
    ...
    def make_strategy_decision(self, current_exposure, risk_assessment, config, market_data):
    ...
    def generate_orders(self, timestamp, exposure, risk_assessment, market_data, pnl=None):
...
class MockDataProvider:
    ...
    def __init__(self):
        self.data = {
            ...
            'venue_data': {
                'binance': {'status': 'active', 'fees': 0.001}
            }
        }
...
class TestWorkflowRefactorE2E:
    ...
    def test_full_loop_sequence_backtest(self, mock_config, mock_data_provider, mock_strategy):
        """Test complete full loop sequence in backtest mode."""
        
        # Create EventDrivenStrategyEngine with mocked strategy
        with patch('backend.src.basis_strategy_v1.core.strategies.strategy_factory.StrategyFactory') as mock_factory:
    ...
    def test_tight_loop_orchestration(self, mock_config, mock_data_provider, mock_strategy):
    ...
    def test_position_reconciliation_backtest_vs_live(self, mock_config, mock_data_provider, mock_strategy):
        ...
        with patch('backend.src.basis_strategy_v1.core.strategies.strategy_factory.StrategyFactory') as mock_factory:
            ...
            backtest_result = engine_backtest.position_update_handler._reconcile_positions()
    ...
    def test_mode_specific_triggers(self, mock_config, mock_data_provider, mock_strategy):
    ...
    def test_error_handling_and_retry(self, mock_config, mock_data_provider, mock_strategy):
    ...
    def test_system_failure_trigger(self, mock_config, mock_data_provider, mock_strategy):
