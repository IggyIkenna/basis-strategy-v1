...
from backend.src.basis_strategy_v1.core.models.instruments import instrument_key_to_price_key, instrument_key_to_oracle_pair
...
class TestCentralizedPricingSimple:
    ...
    def test_utility_manager_price_lookup(self):
        ...
        self.mock_utility_manager.get_price_for_instrument_key.return_value = 50000.0
        
        # Test price lookup
        price = self.mock_utility_manager.get_price_for_instrument_key('wallet:BaseToken:BTC', self.timestamp)
        
        # Verify method was called
        self.mock_utility_manager.get_price_for_instrument_key.assert_called_once_with('wallet:BaseToken:BTC', self.timestamp)
