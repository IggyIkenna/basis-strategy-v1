...
class TestPnLCalculatorUnit:
    ...
    def _add_pnl_config(self, config):
        ...
        config['component_config']['pnl_monitor'] = {
            'attribution_types': ['supply_yield', 'borrow_costs', 'staking_yield_oracle', 'staking_yield_rewards', 'funding_pnl', 'delta_pnl', 'basis_pnl', 'dust_pnl', 'transaction_costs'],
    ...
    def test_all_attribution_types(self, mock_config, mock_data_provider, mock_utility_manager):
        ...
        current_exposure = {
            'exposures': {
                'aUSDT': {'underlying_balance': 1000.0, 'timestamp': pd.Timestamp.now()},
                'aWeETH': {'underlying_native': 0.5, 'oracle_price': 1.05, 'eth_usd_price': 3000.0, 'timestamp': pd.Timestamp.now()},
                'variableDebtWETH': {'underlying_native': 0.1, 'eth_usd_price': 3000.0, 'timestamp': pd.Timestamp.now()}
            },
            'net_delta_eth': 0.1,
            'timestamp': pd.Timestamp.now()
        }
        ...
        previous_exposure = {
            'exposures': {
                ...
                'aWeETH': {'underlying_native': 0.5, 'oracle_price': 1.04, 'eth_usd_price': 3000.0, 'timestamp': pd.Timestamp.now()},
                'variableDebtWETH': {'underlying_native': 0.1, 'eth_usd_price': 3000.0, 'timestamp': pd.Timestamp.now()}
            },
            'net_delta_eth': 0.1,
            'timestamp': pd.Timestamp.now()
    ...
    def test_balance_based_pnl_share_classes(self, mock_config, mock_data_provider, mock_utility_manager):
    ...
    def test_graceful_handling_missing_data(self, mock_config, mock_data_provider, mock_utility_manager):
        ...
        for attr_type in ['supply_yield', 'borrow_costs', 'staking_yield_oracle', 'staking_yield_rewards', 'funding_pnl', 'delta_pnl', 'basis_pnl', 'dust_pnl', 'transaction_costs']:
            assert attr_type in result
    ...
    def test_pnl_monitor_initialization(self, mock_config, mock_data_provider, mock_utility_manager):
    ...
    def test_pnl_monitor_error_handling(self, mock_config, mock_data_provider, mock_utility_manager):
    ...
    def test_pnl_monitor_performance(self, mock_config, mock_data_provider, mock_utility_manager):
    ...
    def test_pnl_monitor_edge_cases(self, mock_config, mock_data_provider, mock_utility_manager):
    ...
    def test_get_pnl_summary(self, mock_config, mock_data_provider, mock_utility_manager):
